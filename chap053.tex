...
The implementations of algorithms and printers from \texttt{contrast\_common\_derived} do not depend on the AST labels, so they can be used with any AST representation.
