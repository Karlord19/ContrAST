...
For \texttt{contrast\_clangtype}, we implemented a table-based cost metric called \texttt{extremescs} for the \texttt{extreme} abstraction, inspired by SimilarityCSharp \cite{similaritycsharp}.
