...
For our evaluation and performance benchmarks, we use a real-world dataset collected from \texttt{ReCodEx}, covering student submissions across the years 2018--2025 as detailed in \autoref{sec:comparatree-statistics}.
Evaluating \texttt{ContrAST} on actual student submissions from our faculty is essential for two reasons.
First, \texttt{ContrAST} is specifically created to be integrated into \texttt{ReCodEx} for these courses, making historical local submissions the most representative benchmark.
Second, standard public clone detection benchmarks primarily target Java or Type 4 functional similarity, whereas our primary focus is detecting Type 1, Type 2, and Type 3 structural clones across multi-year course archives.
To respect student privacy, our dataset is fully anonymized and kept private.
...
Deep syntax analysis allows the system to ignore minor syntactic changes and focus on the underlying code structure.
