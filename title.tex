...
I also declare that the artificial intelligence tools GitHub Copilot and Google Gemini were used during the preparation of this thesis in the period from February 25, 2026, to July 16, 2026.
I used these tools for inline code suggestions, the generation of scripts for plotting graphs, and the linguistic and stylistic revision of the manuscript.
After using these tools, I thoroughly revised and modified the content as required and accept full responsibility for the resulting form of the thesis.
